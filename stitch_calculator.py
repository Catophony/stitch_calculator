...
wanttoknow = Label(window, text="Вы хотите узнать размер вышивки:", font=("Calibri", 12, "bold"))
...
# TODO multilanguage? modules? element alignment is ifferent on various systems - fix
